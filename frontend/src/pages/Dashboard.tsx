...
const Dashboard: React.FC = () => {
    const clinicalTests = [
        {
            ...
            description: "Avalia níveis de atividade física e comportamento sedentário",
    ...
    const highlights = [
        {
            type: "Dica do dia",
            description: "Mantenha os dados do paciente sempre atualizados para melhor acompanhamento."
        },
        {
            type: "Atualização",
        ...
        <div className="h-full bg-gray-50">
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-4">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Dashboard DataAging</h1>
                        <p className="text-sm text-gray-600 mt-1">Bem-vindo de volta, João!</p>
                    </div>
