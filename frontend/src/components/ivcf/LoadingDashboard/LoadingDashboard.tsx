...
const LoadingDashboard: React.FC = () => {
  return (
    <div className="loading-dashboard">
      ...
      {/* Filters Skeleton */}
      <Card className="loading-filters">
        <CardContent className="loading-filters-content">
          <div className="loading-filters-grid">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="loading-filter-item">
      ...
      <Card className="loading-radar-card">
        <CardHeader>
          <div className="skeleton skeleton-chart-title" />
        </CardHeader>
        <CardContent>
          <div className="skeleton skeleton-radar-chart" />
        </CardContent>
      </Card>
    </div>
  );
