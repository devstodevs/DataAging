...
def create_physical_activity_evaluation(db: Session, evaluation_data: dict) -> PhysicalActivityEvaluation:
...
def get_physical_activity_evaluation(db: Session, evaluation_id: int) -> Optional[PhysicalActivityEvaluation]:
...
def get_physical_activity_evaluations_by_patient(
    db: Session, 
    patient_id: int,
    skip: int = 0,
    limit: int = 100
...
def delete_physical_activity_evaluation(db: Session, evaluation_id: int) -> bool:
