...
@router.get("/dashboard/ivcf-summary", response_model=IVCFSummary)
def get_ivcf_summary(db: Session = Depends(get_db)):
    ...
    **Returns:**
    ...
    """
    return DashboardService.get_ivcf_summary(db)


@router.get("/dashboard/ivcf-by-domain", response_model=DomainDistributionResponse)
def get_domain_distribution(
    ...
    **Raises:**
    ...
    """
    return DashboardService.get_domain_distribution(
        db, period_from, period_to, region, health_unit_id, age_range, classification
    )


@router.get("/dashboard/ivcf-by-region", response_model=RegionAverageResponse)
def get_region_averages(
    ...
    **Returns:**
    ...
    """
    return DashboardService.get_region_averages(db, period_from, period_to)


@router.get("/dashboard/ivcf-evolution", response_model=MonthlyEvolutionResponse)
def get_monthly_evolution(
    ...
    **Raises:**
    ...
    """
    return DashboardService.get_monthly_evolution(db, months_back)


@router.get("/dashboard/critical-patients", response_model=CriticalPatientsResponse)
def get_critical_patients(
    ...
    **Raises:**
    ...
    """
    return DashboardService.get_critical_patients(db, pontuacao_minima)


@router.get("/dashboard/curitiba-regions")
def get_curitiba_regions():
    ...
    **Returns:**
    ...
    """
    regions = DashboardService.get_curitiba_regions()
    return {"regions": regions}


@router.get("/dashboard/validate-filters")
def validate_filters(
    ...
    **Returns:**
    - Validation results
    """
    errors = DashboardService.validate_filters(region, age_range, classification)
