    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            ...
            <ExampleContainer
                ...
                description="Os quatro tipos básicos de alerta: error, warning, info e success"
                size="medium"
            >
            ...
            <ExampleContainer
                ...
                description="Alertas em diferentes contextos de aplicação"
                size="medium"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Alert
            ...
            <ExampleContainer
                ...
                description="Alertas para notificações e status do sistema"
                size="medium"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Alert
            ...
            <ExampleContainer
                ...
                description="Alertas para validação de formulários e entrada de dados"
                size="medium"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Alert
            ...
            <ExampleContainer
                title="Mensagens Médicas/Hospitalares"
                description="Alertas específicos para contextos médicos e hospitalares"
                size="medium"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Alert
            ...
            <ExampleContainer
                ...
                description="Alertas com conteúdo extenso e informações detalhadas"
                size="large"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Alert
            ...
            <ExampleContainer
                title="Alertas Dismissíveis"
                description="Alertas que podem ser fechados pelo usuário"
                size="medium"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    {showDismissible && (
            ...
            <ExampleContainer
                title="Com Classe Personalizada"
                description="Alerta com estilização personalizada através de className"
                size="small"
            >
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Alert
